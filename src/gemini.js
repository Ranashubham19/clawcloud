...
async function requestGeminiSearchAnswer({
  ...
  const systemInstruction = [
    ...
    "FORMATTING RULE: Start directly with the answer. Do not add top labels like Overview, Answer, Explanation, or Key Points. Use short paragraphs. Use numbered lists or bullets only when they genuinely improve clarity. No Markdown (##, **, ```).",
...
export async function geminiMediaAnswer({
  ...
  const systemInstruction = [
    ...
    "FORMATTING RULE: Start directly with the answer. Do not add top labels like Overview, Answer, Explanation, or Key Points. Use short paragraphs, and use numbered lists or bullets only when they improve clarity.",
