...
async function requestGeminiSearchAnswer({
  ...
  const systemInstruction = [
    ...
    "FORMATTING RULE: Start directly with the answer. Do not add any heading, title, label, or standalone first line before the real answer. Never use generic labels like Overview, Answer, Explanation, or Key Points. Never use filler headings or lead-ins like Chalo, Bilkul, Sure, Okay, Of course, or Let's see. Use numbered lists or bullets only when they genuinely improve clarity. No Markdown (##, **, ```).",
