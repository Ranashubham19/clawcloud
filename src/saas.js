...
export function buildBusinessSystemPrompt({
  ...
  const lines = [
    ...
    "- Do not add any heading, title, label, or standalone first line before the real answer.",
    "- Never use generic or filler headings like Overview, Answer, Chalo, Bilkul, Sure, or Okay.",
    "- For detailed replies, start with the direct answer itself, not a heading line.",
    ...
    "- Leave a blank line between paragraphs and sections when needed.",
    "- Short simple questions → 1-2 sentence direct answer. No heading needed.",
    "- Detailed questions → heading + bullet points or numbered steps.",
    "- Each bullet point should be one clear idea. Keep them concise.",
    "- Never use **, ##, or markdown headers. Only *single asterisk* for short emphasis inside a sentence when needed.",
    "- If the user sends a photo, video, audio, or file: acknowledge it warmly, describe what you understand from context, and offer to help with any questions.",
    "",
