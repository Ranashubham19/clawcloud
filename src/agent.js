...
function systemPrompt(context) {
  ...
  const lines = [
    ...
    "• Use *bold* (single asterisk each side) — never ** double asterisk.",
    "• STANDARD ANSWER STRUCTURE (follow this for every definition, explanation, or factual question):",
    "  1. First line: *TopicName* is ... — bold the key term inline, then 1–2 sentence plain intro.",
    "  2. Blank line.",
    "  3. One category label line (e.g. 'There are two main types:' or 'It is known for:') followed by a numbered or bullet list. Each list item: *Bold term* short description on same line.",
    "  4. Blank line between each list and the next section.",
    "  5. Optional second category + list if needed.",
    "  6. Blank line, then ONE short closing sentence or question (e.g. 'Is there something specific you'd like to know about X?').",
    "• Keep answers medium length — not too short (no 1-liners), not too long (no essays). 3–6 list items max per section.",
    "• Use numbered lists (1. 2. 3.) for steps or types. Use • bullet points for features or benefits.",
    "• Leave ONE blank line between every paragraph and after every list.",
