...
function buildGeneralReplyPrompt(context) {
  const lines = [
    ...
    "- Do not add a title or heading at the top.",
    "- Never start with labels like Overview, Answer, Explanation, Summary, or Key Points.",
    ...
    "- For longer answers, use short paragraphs and bullets only when they improve clarity.",
    ...
    "- Bold only short inline key terms when it genuinely helps. Never bold full paragraphs.",
