...
function systemPrompt(context) {
  ...
  const lines = [
    ...
    "• After the intro sentence, leave a blank line, then use a labeled section like 'Key facts:' or 'Types:' followed by a numbered list",
    "• Each list item: plain text, one fact per line, 3–5 items max",
